    ...
    try {
      ...
      if (!msg) {
        const greetings = [
          ...
          "uffs ki gorom 🥵",
          "amare ato dkaos kn?",
          "kire bhai? tor somossa ki? bar bar ato dakos kn?kaj kaam nai?bar bar hudai boloder moto ese bot bot kortasos..tor kaj nai deikkha ki amaro kaj nai naki..faltu.ar akbar dakle khobor ache..aktu je relax korbo shanti fe .. .. setaro kno sujog nai..2 mnt por por ese bot bot kore .. .. ja mara kha sla",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
          "আমাকে এতো না ডেকে বস সাইফ একটা গফ দে 🙄",
          "jang hanga korba",
          "jang bal falaba🙂"
        ];
